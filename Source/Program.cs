...
class Program
{
	...
	{
		Log.Info($"Celeste 64 v.{Game.Version.Major}.{Game.Version.Minor}.{Game.Version.Build} (ONLINE)");
	...
	private static void HandleError(Exception e)
	{
		...
		error.AppendLine($"Celeste 64 v.{Game.Version.Major}.{Game.Version.Minor}.{Game.Version.Build} (ONLINE)");
